...
When we want robust consistency in distributed deploy For **Event Sourcing**, we can directly connect necessary components to event streaming platform through its adapters, or we can connect our event bus to event streaming platform.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODE5NjMxNDAxLDQyOTgzNzg3NSw2MzQ3Mj
