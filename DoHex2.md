...
* **lib**: Libraries are used when different data model and/or transformation functions are necessary at that part. Each layer gets data from outside layer and transform that data to inner layer data models. Libraries are **Side Effect**[^10] free and they provide facade interface for usability and testability. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyOTY4NjY5MywxNzY0MDMxNzI5LDIwOD
...
LC0xMDk0MzE4NTg0LC0xMDk0MzE4NTg0LC0xNDc4NjU3MzY5LD
E0NTU5MzI4MTcsLTc0NTM0ODE2NiwtMTY1MDI2NjEzMywtMTY1
MDI2NjEzM119
-->