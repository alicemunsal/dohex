...
components
    ...
    notification
```
This is the fully expanded version of the customer component. Structuring and naming convention are visible. "Service" keyword is added at the end of the each main classes of the parts(app,core,lib). These are th 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4MzkwOTAwNiwxNDk2NjY5OTA0LDEzOD
