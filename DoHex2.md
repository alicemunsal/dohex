...
**lib:**  It contains shared libraries. If we need shared model and/or transformation functions among the components 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODQzNzgwNDgsLTU5ODU2MDQzMywxNz
