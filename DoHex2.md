...
Messaging and scheduling are essential concepts for this architecture. Therefore we may want to inject them directly to the **app** constructor. 
```java
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUzNDIwNjYxNSwtMTg3OTMxODAxMywxOT
