...
lib has 2 folders. models folder contains data models DTOs, POCOs, POJOs, Records or Structs . transformers folder contains transformation functions for these data models.    
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4NzQzNDA0MywtMTY0MzM1OTczMSwtMj
