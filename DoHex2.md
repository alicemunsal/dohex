...
DOD's standpoint is to separate data from behavior. 
* Better testability by deterministic functions instead of statefull objects 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ3Nzk1Mzc2LC0xMTM0Mjk0MDEyLDU4OD
