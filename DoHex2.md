...
* **lib**: Libraries are used when different data model and/or transformation functions are necessary at that part. It transform its model to inner  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA3ODQwNzAyNiwxNjQwMzk3MDY2LDcxMT
