...
*  DoHex is not depended on any programming  languages like C++, C#, Java, Python and new generation languages like Go and Rust.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI3NTIzNDg4OCwtMTg5MDIyNTkzMCwxOT
