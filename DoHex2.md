...
**acl:** Anti corruption layer[^12] for external dependencies and legacy applications. Instead . We should implement facade or adapter pattern for these dependencies.
```
acl	
components
    customer
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ2MjAyNDAwNSwtNTk4NTYwNDMzLDE3Nz
