...
* One of the reason of the invention of the CQRS Pattern[^13] is domain entities are not enough for complex queries. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQ3MTY2NTc2LC0yMDU1NzAwOTQxLC0xNT
