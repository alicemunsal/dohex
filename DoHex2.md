...
We are developing software systems with logical parts (or layers). Each parts may need different data model and/or transformation mechanism.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkxNTcxNTk3NCwtMTUzOTYwOTY4NSwxNj
