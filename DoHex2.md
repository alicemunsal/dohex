...
lib has 2 folders. models folder contains our good old DTOs; or struct in C and Go or record (also immutable) in Java and C#. transformers folder contains transformation functions for these data models.    
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzMDEwMDUzOSwtMTY0MzM1OTczMSwtMj
