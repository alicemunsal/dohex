...
If you think about it, all the architectural patterns we use today, no matter frontend, backend or embedded software,  are some kind of transformations
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzcwNzgwNDQsMTYwMjQwODg3MywtNj
