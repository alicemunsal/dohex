...
* We can start implementation of our application as a monolith then refactor it to microservices application by reasonable effort.   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5MjQ5ODYwMSwtMjEzOTA3NTE5Miw2Nz
